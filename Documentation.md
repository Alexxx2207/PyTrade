...
## Използване на индикаторите

До този момент клиентът няма визуализация на експонентата на Hurst и на пермутационната ентропия. За да се изтестват еднпойнтите за тези индикатори, трябва да се използва инструмент като Postman.
